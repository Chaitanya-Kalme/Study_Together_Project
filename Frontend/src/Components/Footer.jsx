  ...
  return (
    <>
        <div id='Footer' className='flex text-center justify-center bg-gray-500 w-full p-4 lg:gap-36 md:gap-20 sm:gap-5'>
            ...
            {/* Get in Touch */}
            <div>
              <div className='lg:text-2xl sm:text-xl text-red-900 border-blue-900 border-4 p-3 lg:whitespace-nowrap sm:whitespace-normal bg-teal-400 rounded-full'>Get in Touch</div>
              <div className='text-white hover:bg-blue-300 hover:text-red-900 hover:cursor-pointer hover:rounded-full whitespace-nowrap'> support@gmail.com</div>
            </div>
        </div>
    </>
  )
